                ...
                <div class="row align-items-center">
                    <div class="col-xxl-6 col-lg-6">
                        <div class="slider__content-2 mt-30">
                            ...
                            <div class="btn-more">
                                <a href="/pendaftaran" class="tp-btn-green">Daftar Pelatihan</a>
                                <a href="https://itts.ac.id/" class="tp-btn-orange">Kampus ITTS</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-lg-6">
                        <div class="slider__thumb-2 p-relative">
                            ...
                            <span class="slider__thumb-mask">
                                <img src="{{ asset('assets/img/slider/2/person-slide.png') }}" alt="">
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <section class="research__area research__border grey-bg-3 pt-115 pb-90 p-relative z-index-1" id="news">
            <div class="research__shape">
                <img class="research__shape-1 d-none d-sm-block" src="assets/img/research/research-shape-1.png"
                    alt="">
                <img class="research__shape-2 d-none d-sm-block" src="assets/img/research/research-shape-2.png"
                    alt="">
        ...
        <section class="event__area pt-115" id="Trainings">
            <div class="container">
                ...
                <div class="tab-content mt-2">
                                    ...
                                    <div class="event__left d-sm-flex align-items-center">
                                        ...
                                        <div class="event__content">
                                            ...
                                            <h3 class="event__title">
                                                <a href="#">University seminar series on global health.</a>
                                            </h3>
                                ...
                                <div
                                    ...
                                    <div class="event__left d-sm-flex align-items-center">
                                        ...
                                        <div class="event__content">
                                            ...
                                            <h3 class="event__title">
                                                <a href="#">Virtual spring part-time jobs fair for student.</a>
                                            </h3>
                    ...
                    <div class="tab-pane fade" id="pastTraining">
                        <h4>Past Training</h4>
                        <div class="row">
                            <div class="col-xxl-12">
                                <div
